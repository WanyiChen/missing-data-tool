...
export default function LandingPage() {
    ...
    const handleContinue = async () => {
        ...
        try {
            ...
            setErrorModal({
                open: true,
                message: "Could not parse file for preview.",
            });
        } finally {
            setUploading(false);
        }
        ...
        >
            ...
            <div className="w-[90vw] max-w-xl h-[350px] sm:h-[450px] flex flex-col items-center justify-center mb-6 px-4">
                {!uploadSuccess ? (
                    <div
                        {...getRootProps()}
                        className={`border-2 border-dashed rounded-3xl w-full h-full flex flex-col items-center justify-center cursor-pointer transition-colors duration-200 ${
                    ...
                    <div className="border-2 border-dashed rounded-3xl w-full h-full flex flex-col items-center justify-center bg-green-50 border-green-400 animate-fade-in">
                        <div className="flex flex-col items-center justify-center">
                            ...
                            <span className="text-base text-green-700 mb-4">
